module PachubeDataFormats
  class Feed
    ...
    ALLOWED_KEYS = %w(id creator owner_login owner_user_level datastreams description email feed icon location_disposition location_domain location_ele location_exposure location_lat location_lon location_name private status tags title updated website auto_feed_url)
